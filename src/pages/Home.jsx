    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE QUALITY ', 'POWERS', ' PROGRESS.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'POWERS' ? 700 : 300,
                }}
              >
                {line}
              </h1>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Metzim Electrical & Hardware &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['BUILDING MATERIALS', 'ELECTRICAL', 'PLUMBING', 'PAINT', 'TOOLS', 'DELIVERY'];
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80', 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&q=80', 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80', 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&q=80', 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80', 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&q=80'];
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Metzim Electrical & Hardware showcase"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Metzim Electrical & Hardware detail"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Massive Range', desc: 'Over 10,000 products across building, electrical, plumbing, and hardware categories.' },
    { title: 'Competitive Pricing', desc: 'Direct manufacturer relationships mean better prices for you, without compromising quality.' },
    { title: 'Expert Advice', desc: 'Knowledgeable staff who understand construction and can guide you to the right products.' },
    { title: 'Reliable Delivery', desc: 'On-time delivery across Harare and surrounding areas for orders of any size.' }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              alt="Metzim Electrical & Hardware quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Metzim</span>
            </h2>
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          alt="Metzim Electrical & Hardware"
